    ...
    <div className="flex flex-col justify-center flex-none space-y-10">
      <div className="flex flex-col md:flex-row gap-2 lg:gap-2.5">
        <button
          type="button"
          onClick={() => router.back()}
          className="flex items-center justify-center flex-none w-12 h-12 rounded-full text-custom-ligth-text dark:text-custom-dark-text dark:hover:bg-custom-dark-text hover:bg-opacity-5 dark:hover:bg-opacity-10 hover:bg-custom-ligth-text"
        >
        ...
        <div className="flex flex-col space-y-4 px-4 md:px-0">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            {data.github !== "" && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center space-x-2.5 px-5 py-2.5 bg-custom-ligth-text/5 hover:bg-custom-ligth-text/10 dark:text-custom-dark-text dark:bg-custom-dark-text/10 dark:hover:bg-custom-dark-text/20 rounded-xl"
              >
          ...
          <div className="flex space-x-2 items-center py-0.5">
            {data.badges.map(({ name }, i) => (
              <Badge key={i} variant="role" className="rounded-full px-4 py-1 text-sm">{name}</Badge>
            ))}
          </div>
        </div>
      </div>
