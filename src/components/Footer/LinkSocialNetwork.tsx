...
export const LinkSocialNetwork = ({ href, children }: Props) => {
  return (
    <motion.div whileHover="hover" className="relative w-11 h-11 group">
      <motion.div
        className="w-11 h-11 group-hover:bg-custom-light-text group-hover:bg-opacity-5 rounded-xl dark:group-hover:bg-custom-dark-text dark:group-hover:bg-opacity-5"
        transition={{
          ease: "easeInOut",
          duration: 0.65,
        }}
