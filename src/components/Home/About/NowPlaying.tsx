  ...
  return (
    <div className="w-full mb-2 overflow-hidden">
      {!data?.songUrl ? (
        ...
        <div>
          <div className="flex flex-col w-full py-3.5 px-4 space-y-3 rounded-xl dark:bg-white dark:bg-opacity-5 bg-slate-900 bg-opacity-5 hover:bg-opacity-10 dark:hover:bg-opacity-10">
            ...
            {data.songPreview !== null ? (
              ...
              <div className="px-3 py-1.5 rounded-full bg-slate-900/5 dark:bg-slate-900/80">
                <p className="text-sm font-medium text-center">
                  {t.now_playing.pre_not_available}
                </p>
              </div>
            )}
          </div>
